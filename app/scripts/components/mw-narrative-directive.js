...
angular.module('app').directive('mwNarrative', ["$rootScope", "$state", "$location", "$templateCache", "$timeout", "$compile", "Mediator", "Models", "Camera3d", "Camera2d", "Log", "TweenMax", "TimelineMax", "Quad", "config", function($rootScope, $state, $location, $templateCache, $timeout, $compile, Mediator, Models, Camera3d, Camera2d, Log, TweenMax, TimelineMax, Quad, config) {
  ...
  var delta = function(abs_params, abs_paramsp) {
    ...
    try {
      for (var $__3 = void 0,
          $__2 = (Object.keys(abs_params))[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
        var p = $__3.value;
        {
  ...
  var Narrative = function() {
    function Narrative() {
      ...
      $rootScope.$on('$locationChangeSuccess', function(e) {
        ...
        if ($__1.backfwd) {
          $__1.stateObjp = $__1.sequence[$__1.frame];
          if ($__1.sequence[url] < $__1.sequence[$__1.prev_url]) {
            $__1.back = true;
            $__1.frame -= 1;
          } else {
            $__1.back = false;
          ...
          $__1.stateObj = $__1.sequence[$__1.frame];
          $__1.metastate.stateObj = $__1.stateObj;
          $__1.metastate.stateObjp = $__1.stateObjp;
          abs_paramsp = $__1.metastate.stateObjp.abs_params;
          abs_params = $__1.metastate.stateObj.abs_params;
          ...
          try {
            for (var $__3 = void 0,
                $__2 = (terms)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
              var p = $__3.value;
              {
          ...
          $__1.metastate.stateObj.delta_params = delta_params;
          $__1.metastate.stateObj.delta_url = delta_url;
          $__1.stateObj = $__1.metastate.stateObj;
          $timeout(function() {
            $rootScope.$apply(function() {
              $__1.scene = $__1.stateObj.scene;
              $__1.scope().ui.scene = $__1.scene;
            });
          });
        } else {
          $__1.back = false;
        ...
        if ($__1.stateObj.abs_params['ui'].match(/ui-msgbg/)) {
          $__1.test();
        }
      });
      $rootScope.$on('$stateChangeSuccess', function(e) {
        var shot,
            ...
            timeline = function(_delta) {
              ...
              try {
                for (var $__24 = void 0,
                    $__23 = (Object.keys(actors))[Symbol.iterator](); !($__26 = ($__24 = $__23.next()).done); $__26 = true) {
                  var a = $__24.value;
                  {
                    ntuple = a.split(':');
                    type = ntuple[0];
                    ...
                    try {
                      for (var $__3 = void 0,
                          $__2 = (ntuple)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
                        var q = $__3.value;
                        {
                          i++;
                        }
                    ...
                    if (ntuple.length > 0) {
                      ...
                      try {
                        for (var $__10 = void 0,
                            $__9 = (ntuple)[Symbol.iterator](); !($__12 = ($__10 = $__9.next()).done); $__12 = true) {
                    ...
                    try {
                      for (var $__17 = void 0,
                          $__16 = (tweens)[Symbol.iterator](); !($__19 = ($__17 = $__16.next()).done); $__19 = true) {
        ...
        $__1.prev_url = $location.url();
        $__1.backfwd = true;
        if (config.e2e_test) {
          shot = JSON.stringify($__1.scope().shot || {});
    ...
    return ($traceurRuntime.createClass)(Narrative, {
        ...
        switch (control) {
          ...
          case 'csph':
            if (Camera3d.csphere()) {
              ...
              $timeout(function() {
                $rootScope.$apply(function() {
                  $__1.control_state['csph'] = !$__1.control_state['csph'];
                });
              });
            }
            break;
          ...
          case 'back':
            if (Camera3d.light(control)) {
              ...
              $timeout(function() {
                $rootScope.$apply(function() {
                  $__1.control_state[control] = !$__1.control_state[control];
                });
              });
            }
            break;
      ...
      shot: function(shot) {
        ...
        try {
          for (var $__3 = void 0,
              $__2 = (abs_url_components)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
            var c = $__3.value;
            {
              abs_url += (c + "/");
            }
      ...
      change_scene: function(scene) {
        ...
        if (this.scene !== this.stateObj.scene) {
          ...
          try {
            for (var $__3 = void 0,
                $__2 = (this.terms)[Symbol.iterator](); !($__5 = ($__3 = $__2.next()).done); $__5 = true) {
              var p = $__3.value;
              {
      ...
      change_state: function(url) {
        ...
        try {
          for (var $__10 = void 0,
              $__9 = (this.terms)[Symbol.iterator](); !($__12 = ($__10 = $__9.next()).done); $__12 = true) {
        ...
        try {
          for (var $__17 = void 0,
              $__16 = (this.terms)[Symbol.iterator](); !($__19 = ($__17 = $__16.next()).done); $__19 = true) {
        ...
        try {
          for (var $__24 = void 0,
              $__23 = (this.terms)[Symbol.iterator](); !($__26 = ($__24 = $__23.next()).done); $__26 = true) {
...
//# sourceMappingURL=mw-narrative-directive.js.map
