  ...
  var Camera3d = function() {
    ...
    return ($traceurRuntime.createClass)(Camera3d, {
      place: function(canvasId, template_view, _scope, _scene, _clearColor, _alpha, _fov) {
        ...
        clearColor = _clearColor || 0x00000000;
        alpha = _alpha || 0.0;
      ...
      animate: function() {
        ...
        if (scene['animations']) {
          ...
          try {
            for (var $__4 = void 0,
                $__3 = (Object.keys(scene['animations']))[Symbol.iterator](); !($__6 = ($__4 = $__3.next()).done); $__6 = true) {
              var f = $__4.value;
              {
                scene['animations'][f]();
              }
      ...
      lookAt: function(id, y, z) {
        ...
        if (!id) {
          if (config.unit_test) {
            ...
            var a$__11 = [v.x, v.y, v.z];
            return a$__11;
          } else {
            if (csphere) {
              var v$__12 = csphere.position;
              camera.lookAt(v$__12);
        ...
        if (actors[id]) {
          var v$__13 = actors[id].position;
          if (config.unit_test) {
            var a$__14;
            if (v$__13) {
              a$__14 = [v$__13.x, v$__13.y, v$__13.z];
            }
            return a$__14;
          } else {
            if (v$__13) {
              camera.lookAt(v$__13);
...
//# sourceMappingURL=camera3d-service.js.map
